...
public class ProgramDriver {
    ...
    public void deleteAccount(int customerId,long accountNumber)throws DataErrorException{
            try {
    ...
    public void deleteCustomer(int customerId)throws DataErrorException{
        HashMap<Long,AccountInfo> tempAccount=AccountManagement.OBJECT.getAccount(customerId);
       try{
